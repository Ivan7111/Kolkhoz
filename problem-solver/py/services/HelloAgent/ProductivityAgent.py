...
class ProductivityAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        print("finding place's soil type")
                ...
                while cultureIter.Next():
                    ...
                    while soilTypeCollectionIter.Next():
                        ...
                        while soilCoefficientIter.Next():
                            ...
                            print("finding culture's productivity")
                            ...
                            while productivityIter.Next():
                                ...
                                print("creating culture role in collection construction")
                                ...
                                print("creating field role in collection construction")
                                ...
                                if ctx.HelperSetSystemIdtf(str(resultProductivity), resultProductivityNode):
                                    print("idtf changed")
                                else:
                                    print("idtf is not changed")
