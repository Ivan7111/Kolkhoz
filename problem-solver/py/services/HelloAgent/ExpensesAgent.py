        ...
        while placeNodeIter.Next():
            ...
            while areaIter.Next():
                ...
                while cultureIter.Next():
                    ...
                    print("finding culture's needed number of seeds for hectare")
                    nrel_number_of_seeds = ctx.HelperResolveSystemIdtf("nrel_number_of_seeds_per_hectare",
                                                               ScType.NodeConstNoRole)
                    numberOfSeedsIter = ctx.Iterator5(cultureNode, ScType.EdgeDCommonConst, ScType.Node,
                    ...
                    while numberOfSeedsIter.Next():
                        ...
                        print("finding culture's cost of seed")
                        ...
                        while costOfSeedIter.Next():
                            ...
                            print("calculating expenses value")
