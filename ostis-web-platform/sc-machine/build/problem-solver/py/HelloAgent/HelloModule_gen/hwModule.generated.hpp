...
{ \
    ScMemoryContext ctx(sc_access_lvl_make_min, "HelloAgentModule::_InitInternal"); \
    bool result = true; \
     \
    return result; \
}
...
{ \
    ScMemoryContext ctx(sc_access_lvl_make_min, "HelloAgentModule::_InitStaticInternal"); \
    bool result = true; \
    return result; \
}
...
#define hwModule_hpp_HelloAgentModule_impl 
